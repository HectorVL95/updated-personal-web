...
import tptLogo from './assets/tpt_suppliers_logo.png'
...
const DataJob = [
  ...
  {
    id:1,
    company: <a href='https://www.libertydentalplan.com/'  title='Go to website'><img className='companyLogo libLogo' src={ldpLogo} alt='Ldp Logo'/></a>,
  ...
  {
    id:2,
    company: <a href='https://www.loomisco.com/'  title='Go to website'><img className='companyLogo loomisLogo' src={loomisLogo} alt='Loomis Logo'/></a> ,
  ...
  {
    id:3,
    company: <a href='https://www.claritypartners.com/'  title='Go to website'><img className='companyLogo clarityLogo' src={clarityLogo} alt='Clarity Logo'/></a>,
