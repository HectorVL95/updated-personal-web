    ...
    <main className='About-page'>
      ...
      firs-fact'>
        ...
        <div className='fact-text-wrap'>
          <p>Hi my name is Hector, I am 28 years old residing in Tucson, Arizona; I am a front-end web developer, besides doing this trade I also like to ride BMX, write on my journal, travel and learn new skills or test my luck by taking chances on something new. </p>
        </div>
      </section>
