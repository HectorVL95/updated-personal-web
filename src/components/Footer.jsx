    ...
    <footer>
      <section className='footer-info'>
        <div className='social-section'>
          <a href="https://www.linkedin.com/in/hector-valenzuela-8b016416a/"><article className='social-wraps icon-wrap-one'><img className='social-icons' src={linkedIn} alt="LinkedIn" /></article></a>
